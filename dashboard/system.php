...
<?php
	include '../includes/connect.inc.php';
		$sql = $handler->query("SELECT `id`, `content` FROM `pn_about_us`");
			$sql_row = $sql->fetch();
			$id = $sql_row['id'];
			...
			<div class="line_break" style="border-top:1px solid #666;"><br /></div>
				...
				<div class="g-10">
					<div class="activity">
						...
						<span class="act_head">Edit What we are...</span><hr />
						<div class="act_body">
							
							<form action="../functions/edit_about_us.php" name="myform" id="myform" method="POST">
								<p>
									<div id="wysiwyg_cp">
